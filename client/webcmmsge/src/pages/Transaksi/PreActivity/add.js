        ...
        <>
            ...
            <div className="md:container lg:mx-auto  mt-3">
                ...
                <form className='w-full' onSubmit={simpanActivity}>
                    ...
                    {/* /// button simpan */}
                    <button type='submit' className='w-full h-12 px-6 text-red-50 transition-colors duration-150 bg-blue-600 rounded-lg focus:shadow-outline hover:bg-blue-600'>Simpan</button>
                </form>
                {/* </div> */}
            </div>
        </>
