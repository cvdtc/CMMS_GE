...
router.get(
  "/masalah/:flag_activity/:filter_site/:tanggal_awal/:tanggal_akhir",
  jwtVerify,
  function (req, res) {
...
/// AUTOMATION
var RouteToAutomation = require("../controller/automation.controller");
router.get("/pushmould/:site/:nomould", function (req, res) {
  RouteToAutomation.pushmould(req, res);
});
